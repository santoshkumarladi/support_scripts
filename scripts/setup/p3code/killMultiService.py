...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,"hc:u:p:s:n:w:",["cvm=","user=","passwd=","servc=","nos=","wait="])
    ...
    for i in range(nos):
        ...
        for cvm in ser_dict.keys():
            ...
            for sp in serv:
                ...
                elements = get_random_elements(ser_dict[cvm][sp],1)
                if elements != 0 :
                    for pid in elements:
                        pids.append(pid)
