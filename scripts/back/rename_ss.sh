...
sudo mount 10.40.231.204:/volume2 $LOCALMNT1
#sudo mount 10.5.71.180:/volume3 $LOCALMNT2
sudo /usr/bin/find $LOCALMNT1 -maxdepth 1 -type d -not -path "/mnt/afss/corr*" -not -path "/mnt/afss/eggs_DONT_DELETE" -mtime +15 -exec sudo mv {} {}_del \;
