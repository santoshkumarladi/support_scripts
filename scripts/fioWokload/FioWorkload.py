...
if __name__ == "__main__":
	while True:
		...
		for x in bslist1:	
			...
			runcmd=FIO_Cmd(bs = x, bssplit = '8K/50:16K/50', rw = 'readwrite', runtime = '7200', offset = '0', size = '80G', numjobs = 8 , iodepth = iodep, filename = '/dev/sdb' )
			...
			runcmd1=FIO_Cmd(bs = x, bssplit = '4K/40:8K/50:32K/10', rw = 'read', runtime = '7200', offset = '8G', size = '2G', numjobs = 8 , iodepth = iodep, filename = '/dev/sdb' )
			...
			runcmd2=FIO_Cmd(bs = x, bssplit = '8K/50:16K/50', rw = 'randrw', runtime = '7200' , offset = '0', size = '8G', numjobs = 8 , iodepth = iodep, filename = '/dev/sdb' )
